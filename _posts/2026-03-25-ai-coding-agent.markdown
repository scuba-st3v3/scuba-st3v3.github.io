---
layout: post
title:  "My AI Experience So Far"
date:   2026-03-25 2:00:00 -0500
categories: ai
---
...
In early 2026, through inspiration from DHH's [blog post](https://world.hey.com/dhh/promoting-ai-agents-3ee04945), I started experimenting with [Opencode](https://opencode.ai/). Like many of you, I have tried different workflows based off feedback on X. Currently, I am using Opencode within the native terminal inside VSCode. I first started using Claude Sonnet 4.5 via the GitHub Copilot provider but have since switched to using GPT-5.3-Codex.
